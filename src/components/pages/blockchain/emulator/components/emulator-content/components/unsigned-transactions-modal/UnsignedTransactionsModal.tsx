...
import { useGetUnsignedTransactionsQuery } from "@/api/blockchain";
...
export const UnsignedTransactionsModal: FunctionComponent<Props> = memo(({ onClose }) => {
  const [isSecondModalOpen, setIsSecondModalOpen] = useState(false);
  const [selectedTransaction, setSelectedTransaction] = useState<UnsignedTransaction | null>(null);
  const { data: transactions, isLoading } = useGetUnsignedTransactionsQuery();
...
UnsignedTransactionsModal.displayName = "UnsignedTransactionsModal";
